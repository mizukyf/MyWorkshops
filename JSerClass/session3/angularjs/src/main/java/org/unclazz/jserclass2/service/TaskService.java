...
public class TaskService {
	...
	{
		// ダミーデータの登録
		mockRecords.add(new Task(mockSequence.incrementAndGet(), "4月までにバシュラールを再読", 2));
		mockRecords.add(new Task(mockSequence.incrementAndGet(), "3月中にOSS-DB Gold資格試験の申込み", 3));
		mockRecords.add(new Task(mockSequence.incrementAndGet(), "3/11までにJSer Class #3のテキストの構想をまとめる", 1));
		mockRecords.add(new Task(mockSequence.incrementAndGet(), "X/XX PAULのキッシュロレーヌを試してみる", 3));
	}
